            ...
            @forelse($orders as $ord)
                ...
                <tr>
                    <td style="white-space: nowrap;">
                        <div style="font-family: var(--font-mono); color: var(--primary-red); font-size: 0.85rem; font-weight: 700; white-space: nowrap;">{{ $ord->order_code }}</div>
                    ...
                    <td style="white-space: nowrap;">
                        <span style="font-size: 0.8rem; font-family: var(--font-mono); font-weight: 700; color: var(--primary-red); white-space: nowrap;">
    ...
    <div class="modal-box" style="max-width: 760px;">
        <div class="modal-header">
            <div>
                ...
                <p id="modalOrderCodeHeader" style="font-size: 0.8rem; color: var(--primary-red); font-family: var(--font-mono); margin-top: 2px;"></p>
            </div>
        ...
        <div class="modal-body" style="padding-top: 18px;">
            ...
            <div style="background: var(--bg-surface-alt); border: 1px solid var(--border-color); border-radius: 12px; padding: 16px; margin-bottom: 20px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
                ...
                <div>
                    ...
                    <div id="modalRequestedDelivery" style="font-size: 0.85rem; font-weight: 700; color: var(--primary-red); font-family: var(--font-mono); margin-top: 4px;"></div>
                </div>
                <div>
            ...
            <div style="margin-bottom: 20px; font-size: 0.85rem; background: var(--bg-surface-alt); border: 1px solid var(--border-color); border-radius: 10px; padding: 14px;">
                ...
                <div id="modalNotesContainer" style="display: none;">
                    ...
                    <div id="modalNotes" style="color: var(--text-secondary); margin-top: 4px; font-style: italic; background: #fafbfc; border: 1px solid var(--border-color); padding: 8px 12px; border-radius: 6px;"></div>
                </div>
            </div>
            ...
            <form id="updateOrderStatusForm" method="POST" style="background: var(--bg-surface-alt); border: 1px solid var(--border-color); border-radius: 12px; padding: 18px; margin-bottom: 20px;">
                @csrf
            ...
            <div>
                ...
                <div id="modalStatusLogs" style="background: var(--bg-surface-alt); border: 1px solid var(--border-color); border-radius: 10px; padding: 14px; max-height: 180px; overflow-y: auto;">
                    <!-- Populated dynamically -->
                </div>
            </div>
        </div>
                    ...
                    data.messages.forEach(msg => {
                        ...
                        bubble.innerHTML = `
                            <div class="chat-msg-header">
                                <span class="chat-msg-sender" style="color: ${isSupplier ? '#059669' : 'var(--primary-red)'};">
