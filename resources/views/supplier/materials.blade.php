    ...
    <form method="GET" action="{{ route('supplier.materials') }}" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 16px;">
        ...
        <div style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 260px;">
            <div style="position: relative; width: 100%; max-width: 360px;">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search catalog by name, code, or specs..." class="input-field search-input-with-icon" style="width: 100%; padding-left: 38px !important; font-size: 0.85rem;">
