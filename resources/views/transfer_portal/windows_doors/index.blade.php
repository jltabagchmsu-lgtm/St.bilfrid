...
@section('title', 'Windows & Doors Materials Transfer Station - St. Bilfrid Development Corporation')
...
<div style="display: flex; flex-direction: column; gap: 24px;">
    ...
    <div class="card" style="background: linear-gradient(135deg, rgba(56, 189, 248, 0.12) 0%, rgba(15, 23, 42, 0.8) 100%); border: 1px solid rgba(56, 189, 248, 0.3); padding: 22px 26px; border-radius: var(--radius-lg); position: relative; overflow: hidden;">
    ...
    <!-- Section 1: Central Warehouse Windows & Doors Inventory Catalog -->
    ...
    <div class="card" style="padding: 24px;">
        ...
        <div style="overflow-x: auto;">
            <table class="data-table">
                ...
                <tbody>
                    @forelse($projectWindowDoorMaterials as $pm)
                    <tr>
                        <td>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="{{ route('windowsDoors.printVoucher', $xf->id) }}" target="_blank" class="btn-secondary" style="padding: 5px 12px; font-size: 0.75rem; font-weight: 700; display: inline-flex; align-items: center; gap: 4px;">
                    ...
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 30px; color: var(--text-muted);">
                            No windows & doors material transfer vouchers recorded yet.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
...
<div id="dispatchStockModal" class="modal" style="display: none;">
    ...
    <div class="modal-content" style="max-width: 540px; background: #0f172a; border: 1px solid rgba(56, 189, 248, 0.4); border-radius: var(--radius-lg); padding: 28px; position: relative; z-index: 1000; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.7);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid var(--border-color); padding-bottom: 14px;">
            <h3 style="font-size: 1.2rem; font-weight: 800; color: #f8fafc; display: flex; align-items: center; gap: 8px;">
                <span>Dispatch Doors & Windows to Project Site</span>
            </h3>
        ...
        <form action="{{ route('windowsDoors.dispatchStock') }}" method="POST">
            @csrf
            <div class="form-group" style="margin-bottom: 16px;">
                <label class="form-label" style="display: block; font-size: 0.825rem; font-weight: 700; color: var(--text-secondary); margin-bottom: 6px;">
...
<div id="interProjectModal" class="modal" style="display: none;">
    ...
    <div class="modal-content" style="max-width: 540px; background: #0f172a; border: 1px solid rgba(139, 92, 246, 0.4); border-radius: var(--radius-lg); padding: 28px; position: relative; z-index: 1000; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.7);">
        ...
        <form action="{{ route('windowsDoors.transferInterProject') }}" method="POST">
            @csrf
            <div class="form-group" style="margin-bottom: 16px;">
                <label class="form-label" style="display: block; font-size: 0.825rem; font-weight: 700; color: var(--text-secondary); margin-bottom: 6px;">
...
<div id="returnExcessModal" class="modal" style="display: none;">
    ...
    <div class="modal-content" style="max-width: 500px; background: #0f172a; border: 1px solid rgba(16, 185, 129, 0.4); border-radius: var(--radius-lg); padding: 28px; position: relative; z-index: 1000; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.7);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid var(--border-color); padding-bottom: 14px;">
            <h3 style="font-size: 1.2rem; font-weight: 800; color: #f8fafc; display: flex; align-items: gap: 8px;">
        ...
        <form action="{{ route('windowsDoors.returnExcess') }}" method="POST">
            @csrf
